<template>
  <div class="section-white content-padded">
    <el-form v-model="form" :ref="form" class="add-form">
      <el-form-item label="活动名称">
        <el-input v-model="form.active_name" placeholder="请填写活动名称"></el-input>
      </el-form-item>
        ...
        <div>
          <el-card class="box-card">
            ...
            <el-checkbox-group v-model="checkedMobile" @change="handleCheckedMobileChange">
              <div>
                <el-checkbox v-for="item in mobileData" :label="item" :key="item">{{
                  item
                }}</el-checkbox>
              </div>
            </el-checkbox-group>
      ...
      <el-form-item label="设置礼品">
        ...
        <el-table :data="form.activeData" class="table">
          ...
          <el-table-column prop="worth" label="价值"></el-table-column>
    ...
    <gift-dialog :switch-on="isopen" @closeDialog="closeDialog"></gift-dialog>

    <el-dialog title="添加手机号" :visible.sync="addmobileVisible">
      <div>
        <span>手机号：</span
        ><el-input v-model="mobile" placeholder="请输入手机号" style="width: 240px;"></el-input>
      </div>
