          ...
          <el-form :ref="couponForm" v-model="couponForm" label-width="120px">
              ...
              <el-radio-group v-model="couponForm.money">
                <div>
                  <el-radio label="fixedMoney"
                    >指定金额&nbsp;<el-input v-model="fixedMoney" placeholder="金额"></el-input
                    >&nbsp;元</el-radio
                  >
                </div>
                <div>
                  <el-radio label="fixedDiscount"
                    >指定折扣&nbsp;<el-input v-model="fixedDiscount" placeholder="折扣"></el-input
                    >&nbsp;折</el-radio
                  >
                </div>
                <div>
            ...
            <el-form-item label="使用条件">
              <el-radio-group v-model="couponForm.use_condition">
                <div><el-radio label="none">无条件</el-radio></div>
                <div>
                  <el-radio label="conditionMoney"
                    >满&nbsp;<el-input v-model="conditionMoney" placeholder="指定金额"></el-input
                    >&nbsp;元使用</el-radio
                  >
                </div>
              </el-radio-group>
        ...
        <template v-else-if="gift_type == 'exchange'">
          <el-form :ref="exchangeForm" v-model="exchangeForm" label-width="120px">
            <el-form-item label="兑换券名称">
              <el-input v-model="exchangeForm.name" placeholder="请输入优惠券名称"></el-input>
            </el-form-item>
            <el-form-item label="发放数量">
              <el-input-number v-model="exchangeForm.num" :min="1"></el-input-number>
            </el-form-item>
        ...
        <template v-else-if="gift_type == 'goods'">
          <el-form :ref="goodsForm" v-model="goodsForm" label-width="120px">
            <el-form-item label="礼品名称">
              <el-input v-model="goodsForm.name" placeholder="请输入优惠券名称"></el-input>
            </el-form-item>
            <el-form-item label="发放数量">
    ...
    >
      ...
      <el-table :data="goodsList" style="width: 100%" v-loading="loading">
        ...
        <el-table-column label="操作" width="120">
          <template slot-scope="scope">
            <el-button type="primary" size="small" @click="chooseGoods(scope.row)">选择</el-button>
          </template>
        </el-table-column>
      </el-table>
    </el-dialog>
