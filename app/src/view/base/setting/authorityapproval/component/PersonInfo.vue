  ...
  <el-card class="cus-card">
    ...
    <div class="avater-box">
      <div class="flex-avater-box">
        ...
        <el-tag :type="operatorInfo.operator_type === 'staff' ? 'success' : 'warning'" size='medium' style="margin-left:25px">{{operatorInfo.operator_type === 'staff' ? '平台管理员' : '店铺管理员'}}</el-tag>
      </div>
      <img v-if="info.status == '1'" src="@/assets/img/adapay/pass.png" style="width:80px;height:64px" alt="" >
      <img v-if="info.status == '2'" src="@/assets/img/adapay/reject.png" alt="" style="width:70px;height:69px" >
    </div>
    <el-row class="cus-info-box">
      ...
      <el-col :span="24" v-if="operatorInfo.operator_type === 'staff'">
