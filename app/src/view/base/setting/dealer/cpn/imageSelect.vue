<template>
   <el-dialog class="img_dialog" title="选择图片" :visible="showDialog" :close-on-click-modal="false" :close-on-press-escape="false" :before-close="cancelAction" append-to-body>
    <div class="img_pick_panel inner_container_box">
      <el-row>
        <el-col>
          <el-tabs v-model="activeName" @tab-click="handleClick">
            <el-tab-pane v-if="$store.getters.login_type != 'distributor'"  label="微信上传" name="wechatimages">
              <div class="inner_main" v-loading="loading">
                <div class="img_pick_area">
                  ...
                  <div class="img_pick_area_inner">
                    <div class="img_pick">
                      <div class="img_list">
                        <div class="img_item" v-for="(item, index) in imgList" :key="index" @click="checkedImg(item, index)">
                          <div class="frm_checkbox_label img_item_bd" :class="isMost ? {selected: item.selected} : {'selected': i == index}">
                            <div class="pic_box">
              ...
              <div class="inner_main" v-loading="loading">
                <div class="img_pick_area">
                  ...
                  <div class="img_pick_area_inner">
                    <div class="img_pick">
                      <div class="img_list">
                        <div class="img_item" v-for="(item, index) in localimgList" :key="index" @click="localcheckedImg(item, index)">
                          <div class="frm_checkbox_label img_item_bd" :class="isMost ? {selected: item.selected} : {'selected': locali == index}">
                            <div class="pic_box">
...
<script>
  ...
  import { getUploadQiniuPicToken, uploadQiniuPic, getUploadPic, getQiniuPicList, deleteImage } from '@/api/qiniu'
  export default {
    ...
    methods: {
      ...
      getImageList () {
        let that = this;
        that.loading = true
        getWechatMaterial (this.params).then(response => {
      ...
      getLocalImageList () {
        ...
        if ( !this.localisLoadData ) {
          ...
          getQiniuPicList (that.localparams).then(response => {
