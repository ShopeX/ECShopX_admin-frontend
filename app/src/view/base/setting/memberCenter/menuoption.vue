    ...
    <el-form ref="form" :model="form" label-position="left" label-width="170px">
      <div class="section-body">
        ...
        <el-form-item label="是否展示我要分享：">
          <el-switch v-model="form.data.share_enable"></el-switch>
        </el-form-item>
        <el-form-item label="是否展示个人信息：">
          <el-switch v-model="form.data.memberinfo_enable"></el-switch>
        </el-form-item>
      </div>
