<template>
  <el-form ref="form" label-width="100px">
    <el-form-item label="公众账号ID">
      ...
      <br />
      <span class="frm-tips"
        >微信支付分配的公众账号ID（企业号corpid即为此appId）</span
      >
    </el-form-item>
        ...
        getPaymentSetting(query).then((response) => { 
          ...
          let form =
            Array.isArray(response.data.data) && !response.data.data.length
              ...
              : response.data.data;
          form.is_servicer =
            response.data.data.is_servicer == "true" ? true : false;
