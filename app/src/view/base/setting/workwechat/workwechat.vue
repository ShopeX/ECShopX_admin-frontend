              ...
              <el-card shadow="never">
                ...
                <div class="introduce-Flex">
                  ...
                  <div class="content">
                    ...
                    <p>
                      2.
                      点击进入应用详情页，找到「功能」中的「接收消息」，点击「设置
                      API 接收」，依次复制下方内容填写至对应输入框中。
                    </p>
                  </div>
                </div>
        ...
        <div class="list">
          ...
          <div class="formBox">
            <div class="introduce">
              ...
              <p>
                3.
                将下方「可信域名」复制至企业微信后台的「可信域名」，并点击申请校验域名。
              </p>
              <p>4. 点击确定。</p>
            </div>
            <el-form ref="form" label-width="150px">
         ...
         <div class="list">
          ...
          <div class="formBox">
            <div class="introduce">
              <p>操作指南：</p>
              <p>
                1. 接上方操作，点击企业微信说明中第一步的「下载文件」。
              </p>
              <p>
                2. 回到云店后台，点击下方上传文件，选择刚刚下载的文件。
              </p>
              <p>3. 回到企业微信后台，点击确定。</p>
            ...
            <el-form ref="form" label-width="150px">
              <el-card shadow="never">
                <el-form-item label="域名文件" class="first yuming">
                  <div class='line'>
                  <div class='filename'><span v-if='form.agents.dianwu.verify_file_name'>已上传：</span>{{form.agents.dianwu.verify_file_name}}</div>
                  <el-upload
                    class="upload-demo"
                    :action="uploadUrl"
