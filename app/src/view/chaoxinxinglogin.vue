...
export default {
  ...
  mounted() {
    console.log('-----6')
    this.$store.dispatch('setLoginType', 'chaoxinxing')
    this.brand = require('@/assets/img/chaoxinxing/logo.svg')
    this.login_bg = require('@/assets/img/chaoxinxing/login_bg.jpg')
  }
}
</script>
...
.log-body {
  padding: 118px 0;
  // background: url(@/assets/static/img/login_bg.jpg) no-repeat center center;
