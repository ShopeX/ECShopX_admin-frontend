  ...
  <div class="section-white">
    ...
    <div class="section-body">
      <el-row>
        ...
        <el-col :span="20">{{ refundDetail.refund_bn }}</el-col>
      </el-row>
      <el-row>
        <el-col :span="3" class="col-3 content-right">订单号:</el-col>
        <el-col :span="20">{{ refundDetail.order_id }}</el-col>
      </el-row>
      <el-row>
        <el-col :span="3" class="col-3 content-right">售后单号:</el-col>
        <el-col :span="20">{{ refundDetail.aftersales_bn }}</el-col>
      </el-row>
      <el-row>
        <el-col :span="3" class="col-3 content-right">对应支付单号:</el-col>
        <el-col :span="20">{{ refundDetail.trade_id }}</el-col>
      </el-row>
      <el-row>
      ...
      <el-row>
        ...
        <el-col :span="20">{{ refundDetail.refund_point }}</el-col>
      </el-row>
      <el-row>
        <el-col :span="3" class="col-3 content-right">实退积分:</el-col>
        <el-col :span="20">{{ refundDetail.refunded_point }}</el-col>
      </el-row>
      <el-row>
      ...
      <el-row>
        ...
        <el-col :span="20">
          <el-tag
            ...
            >不退运费</el-tag
          >
          <el-tag v-else-if="refundDetail.return_freight == '1'" effect="plain" size="mini"
            >退运费</el-tag
          >
        </el-col>
      </el-row>
      ...
      <el-row>
        ...
        <el-col :span="20">{{ refundDetail.refunds_memo }}</el-col>
      </el-row>
      <el-row>
        <el-col :span="3" class="col-3 content-right">第三方退款单号:</el-col>
        <el-col :span="20">{{ refundDetail.refund_id }}</el-col>
      </el-row>
      <el-row>
        <el-col :span="3" class="col-3 content-right">申请时间:</el-col>
        <el-col :span="20">{{ refundDetail.create_time | datetime('YYYY-MM-DD hh:mm:ss') }}</el-col>
      </el-row>
      <el-row>
      ...
      <el-row v-if="refundDetail.refuse_reason">
        ...
        <el-col :span="20">{{ refundDetail.refuse_reason }}</el-col>
      </el-row>
    </div>
