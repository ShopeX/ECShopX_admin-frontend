...
<template>
  <el-card v-if="data.length > 0" class="refund_info_card">
    ...
    <el-table
      ...
      <el-table-column prop="refund_bn" label="退款单号"></el-table-column>
        <el-table-column prop="refund_id" label="汇付退款单号"></el-table-column>
      <el-table-column prop="distributor_name" label="退款客户名称"></el-table-column>
