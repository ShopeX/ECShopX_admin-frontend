  ...
  <section class="section section-white content-padded" onload="init()">
    <el-form ref="form" :model="form" label-width="110px">
      ...
      <el-form-item label="店铺名称">
        <div>
          <el-col :span="8">
            <el-input v-model="form.name" placeholder="请先完成下方地理位置的选择"></el-input>
          </el-col>
        </div>
      </el-form-item>
      <el-form-item label="店铺号" prop="shop_code" :rules="rules.shop_code">
        <div>
          <el-col :span="8">
            <el-input v-model="form.shop_code" :maxlength="10" placeholder="请输入店铺号" :disabled="disabled"></el-input>
            <div class="frm-tips">配置的店铺号会在交易单中作为前缀，以便财务对账，最多10位, 仅支持英文数字</div>
          </el-col>
        </div>
      </el-form-item>
      <el-row>
        <el-col :span="5" v-if="!distributor_type">
      ...
      <el-form-item label="是否分账" v-if="isOpen">
        <el-switch
      ...
      <el-form-item label="平台服务费" v-if="isOpen">
        <el-input
          class="first"
          type="number"
          min="0"
