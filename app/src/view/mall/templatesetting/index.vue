<template>
  <div style="padding-bottom: 58px">
    ...
    <el-card>
      <div class="card">
        <div class="card_title">
          <div class="card_title_tip title">积分商品筛选条件</div>
        </div>
        <div class="card_content2">
          <div class="brand_item content_item">
            <div class="title">按品牌筛选</div>
            <div class="com">
              <el-switch
            ...
            <div class="desc">开启后，将显示所有积分商品的品牌。</div>
          </div>
          <div class="brand_item content_item">
            <div class="title">按分类筛选</div>
            <div class="com">
              <el-switch
            ...
            <div class="desc">开启后，将显示所有带有商品的商品分类。</div>
          </div>
          <div class="brand_item content_item">
            <div class="title">按积分筛选</div>
            <div class="com">
              <el-switch
            ...
            <div class="desc">开启后，用户可按您配置好的积分区间挑选商品。</div>
          </div>
          <Table
...
export default {
  ...
  methods: {
    ...
    save() {
      ...
      const isEmptyPoint = point_section.some(
        (item, index) => item.score1 == 0 && item.score2 == 0
      );
      ...
      saveTemplateSetting({
        ...
        screen: {
          ...
          cat_openstatus,
          point_openstatus,
          point_section: point_section.map((item, index) => [
            item.score1,
            item.score2,
          ]),
        },
