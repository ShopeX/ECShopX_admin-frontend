  ...
  <el-table ref="Table" :data="seletedCoupon" tooltip-effect="dark" style="width: 100%" border>
    <el-table-column label="卡劵类型" width="120">
      <template slot-scope="scope">
        <template v-if="scope.row.card_type == 'new_gift'">兑换券（新）</template>
    ...
    <el-table-column prop="title" label="卡劵名称" width="120"> </el-table-column>
    <el-table-column prop="description" label="卡劵说明" show-overflow-tooltip> </el-table-column>
    ...
    <el-table-column prop="give_num" label="发送数量"  width="100"  show-overflow-tooltip> </el-table-column>
    <el-table-column fixed="right" label="操作" width="100" v-if="type!='edit'">
      <template slot-scope="scope">
        <el-button
        style="color: #409EFF;"
