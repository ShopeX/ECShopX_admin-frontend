<template>
  <div>
    <div v-if="$route.path.indexOf('editor') === -1">
      <el-row :gutter="20">
        <el-col :md="4" :lg="8">
          <el-button size="mini" type="primary" icon="plus" @click="addPackagePromotion"
            >添加组合促销</el-button
          >
        </el-col>
      </el-row>
      <el-tabs type="border-card" v-model="activeName" @tab-click="handleClick">
        ...
        >
          <el-table-column prop="package_id" width="60" label="编号"></el-table-column>
          <el-table-column prop="package_name" label="组合促销名称"></el-table-column>
          ...
          <el-table-column label="操作" width="150">
            <template slot-scope="scope">
              <div class="operating-icons">
                ...
                <el-button @click="showPackagePromotion(scope.row)" type="text">查看</el-button>
                <el-button
