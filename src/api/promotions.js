...
export function batchGetActivityList(query) {
  return fetch({
    url: '/marketing/batchGetList',
    method: 'post',
    params: query
  })
}
...
//审核
export function auditPromotion(query) {
  return fetch({
    url: '/marketing/audit',
    method: 'post',
    params: query
...
//上下架
export function approvePromotion(query) {
  return fetch({
    url: '/marketing/approve',
    method: 'post',
    params: query
  })
}
...
//创建活动集合页面
export function createCollection(query) {
  return fetch({
    url: '/promotions/collection/create',
    method: 'post',
    params: query
  })
}
...
//活动集合页详情
export function getCollectionDetail(query) {
  return fetch({
    url: '/promotions/collection/detail',
    method: 'GET',
    params: query
  })
}
...
//更新活动集合
export function updateCollection(query) {
  return fetch({
    url: '/promotions/collection/update',
    method: 'post',
    params: query
  })
}
...
export function deleteCollection(collection_id) {
  return fetch({
    url: '/promotions/collection/deleteCollection?collection_id=' + collection_id,
    method: 'delete'
  })
}
...
//删除限时特惠
export function deleteSeckillactivity(query) {
  return fetch({
    url: '/promotions/seckillactivity/delete',
    method: 'delete',
    params: query
  })
}