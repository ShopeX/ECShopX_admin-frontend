    ...
    <div class="section-body">
      <el-form label-width="150px" label-position='left'>
        ...
        <el-form-item v-if="config.type === 'goods'" label="选择商品">
          ...
          <el-row :gutter="20" v-if="items.length > 0 && items[0].imgUrl"   class="content-bottom-padded" style="margin-left: 0px;">
            <draggable
              v-if="items.length > 0 "
              v-model="items"
            ...
            >
                ...
                <el-col :span="6" @mouseover.native="mouseoverHandle(index)" @mouseleave.native="mouseleaveHandle()" class="setting-item item-selected" v-for="(item, index) in data" :key="index">
