        ...
        <el-card shadow="never">
          <el-form ref="form" :model="form" label-position="top" label-width="80px">
            ...
            <el-form-item label="副标题">
              <el-input v-model="form.summary" placeholder="请输入副标题" />
            </el-form-item>
            <el-form-item label="作者名称">
              <el-input v-model="form.author" type="text" style="width: 300px" />
            </el-form-item>
            ...
            <el-form-item v-if="renderable" label="地区选择">
              <region-select :default-address="defaultAddress" @change="changeRegion" />
            ...
            <el-form-item label="发布样式编辑">
              ...
              <imgBox v-if="form.image_url" :img-url="wximageurl + form.image_url" />
            </el-form-item>
            <el-form-item label="分享图片">
              <div>分享图片 <span class="form-text-tip">建议尺寸：200像素 * 200像素</span></div>
              <el-button @click="addSharePreview"> 从图片库选择 </el-button>
              <imgBox v-if="form.share_image_url" :img-url="wximageurl + form.share_image_url" />
            </el-form-item>
          </el-form>
        </el-card>
      </el-col>
