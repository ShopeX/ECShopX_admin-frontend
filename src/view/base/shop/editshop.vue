...
<template>
  <section class="section section-white content-padded" onload="init()">
    <el-form ref="form" :model="form" label-width="110px">
      <el-form-item :label="$t('345b9595.a1bb9c')">
        <el-col :span="10">
          <el-radio-group
          ...
          >
            <el-radio :label="1" value="1" disabled>{{ $t('345b9595.227dd1') }}</el-radio>
            <el-radio :label="2" value="2" disabled>{{ $t('345b9595.cf4787') }}</el-radio>
          </el-radio-group>
          <el-radio-group v-else v-model="form.is_domestic" @change="isDomesticChange">
            <el-radio :label="1" value="1">{{ $t('345b9595.227dd1') }}</el-radio>
            <el-radio :label="2" value="2">{{ $t('345b9595.cf4787') }}</el-radio>
          </el-radio-group>
        </el-col>
      </el-form-item>
      <el-form-item :label="$t('345b9595.0306b5')">
        <el-col :span="10">
          <el-radio-group v-model="form.is_direct_store">
            <el-radio :label="1" value="1">{{ $t('345b9595.4b940c') }}</el-radio>
            <el-radio :label="2" value="2">{{ $t('345b9595.c26325') }}</el-radio>
          </el-radio-group>
        </el-col>
      </el-form-item>
      <el-form-item v-if="form.is_domestic == 1" :label="$t('345b9595.fc82aa')">
        <el-col :span="4">
          <el-cascader :options="regions" change-on-select @change="handleRegionChange" />
        </el-col>
        <el-col :span="7">
          <el-input id="keyword" v-model="form.address" :placeholder="$t('345b9595.d17095')" />
        </el-col>
        <el-col :span="1" class="content-center"> &nbsp; </el-col>
        <el-col :span="3">
          <el-button type="primary" @click="searchKeyword()">{{ $t('345b9595.83546a') }}</el-button>
        </el-col>
      </el-form-item>
      <el-form-item v-if="form.is_domestic == 1" :label="$t('345b9595.86188c')">
        <el-col :span="4">
          <div id="qqmap_rslist" />
        </el-col>
        <el-col :span="12">
      ...
      <el-form-item :label="$t('345b9595.740032')">
        <div>
          <el-col :span="8">
            <el-input v-model="form.shopname" :placeholder="$t('345b9595.7c3c07')" />
          </el-col>
        </div>
      </el-form-item>
      <el-form-item v-if="form.is_domestic == '2'" :label="$t('345b9595.a345de')">
        <div>
          <el-col :span="1">
            <el-input v-model="form.country" :placeholder="$t('345b9595.ee3f55')" />
          </el-col>
          <el-col :span="1" class="content-center"> - </el-col>
          <el-col :span="2">
            <el-input v-model="form.city" :placeholder="$t('345b9595.f7d29d')" />
          </el-col>
          <el-col :span="1" class="content-center"> - </el-col>
          <el-col :span="5">
            <el-input v-model="form.address" :placeholder="$t('345b9595.61a0ec')" />
          </el-col>
        </div>
      </el-form-item>
      <el-form-item v-if="form.is_domestic == 2" :label="$t('345b9595.ca5ba1')">
        <el-col :span="8">
          <el-input v-model="form.company_name" />
        </el-col>
        <el-col>
          <p class="frm-tips">{{ $t('345b9595.ac8ce8') }}</p>
        </el-col>
      </el-form-item>
      <el-form-item inline="true" class="demo-form-inline" :label="$t('345b9595.8545dd')">
        <el-col :span="3">
          <el-input v-model="form.lng" readonly :placeholder="$t('345b9595.3d18ca')" />
        </el-col>
        <el-col :span="1" class="content-center"> - </el-col>
        <el-col :span="3">
          <el-input v-model="form.lat" readonly :placeholder="$t('345b9595.6acaee')" />
        </el-col>
      </el-form-item>
      ...
      <el-form-item :label="$t('345b9595.d63742')">
        <el-row :gutter="20">
          <el-col :span="18">
            <div class="frm-tips">
              {{ $t('345b9595.056495') }}
      ...
      <el-form-item :label="$t('345b9595.e84643')">
        <el-col :span="8">
          <el-input v-model="form.contract_phone" />
        </el-col>
        <el-col>
          <p class="frm-tips">{{ $t('345b9595.7b78e9') }}</p>
        </el-col>
      </el-form-item>
      <el-form-item :label="$t('345b9595.cc3307')">
        <el-col :span="5">
          <el-time-picker
            v-model="opentime"
            is-range
            format="HH:mm"
            type="fixed-time"
            :placeholder="$t('345b9595.cc3307')"
            style="width: 100%"
            @change="selectDateChange"
          />
        </el-col>
        <el-col>
          <p class="frm-tips">{{ $t('345b9595.a7bd0e') }}</p>
        </el-col>
      </el-form-item>
      <el-form-item
        v-show="add_flag === 1"
        v-if="form.is_domestic == '1'"
        :label="$t('345b9595.be228b')"
      >
        <el-radio-group v-model="form.add_type">
          <div style="margin-bottom: 10px">
            <el-radio :label="1">
              {{ $t('345b9595.0418fa') }}&nbsp;<span class="frm-tips">({{ principal_name }})</span>
            </el-radio>
          </div>
          <div>
            <el-radio :label="2">
              {{ $t('345b9595.8d85c1') }}&nbsp;<span class="frm-tips">{{
                $t('345b9595.608963')
              }}</span>
            </el-radio>
          </div>
      ...
      <el-form-item
        v-show="form.add_type == '2' && add_flag === 1"
        v-if="form.is_domestic == 1"
        :label="$t('345b9595.9bd9d3')"
      >
        <el-col>
          <p class="frm-tips">{{ $t('345b9595.3a3821') }}</p>
        </el-col>
        <el-col>
          <el-upload
    ...
    <div v-show="qqmap_infowin_flag" id="qqmap_infowin">
      <el-col>
        <el-button type="primary" @click="imp_poi(poi_info)">{{ $t('345b9595.0310ee') }}</el-button>
      </el-col>
  ...
  methods: {
    ...
    onSubmit() {
      ...
      if (this.form.is_domestic == 1) {
        if (!this.form.address || !this.form.lng || !this.form.lat) {
          this.$message.error(this.$t('345b9595.b98f4b'))
          return false
        }
      }
      ...
      if (this.wxShopsDetailData.wx_shop_id) {
        ...
        updateWxShops(this.wxShopsDetailData.wx_shop_id, params).then((response) => {
          if (response.data.data.wx_shop_id) {
            ...
            this.$message.error(this.$t('345b9595.08141b'))
            return false
          }
        })
      } else {
    ...
    qqmapinit: function (lat, lng) {
      ...
      this.searchService = new qq.maps.SearchService({
        ...
        //若服务请求失败，则运行以下函数
        error: function () {
          that.$message.error(that.$t('345b9595.08141b'))
        }
      })
    },
    ...
    searchKeyword: function () {
      ...
      if (!this.form.region) {
        this.$message({
          message: this.$t('345b9595.ad1a24'),
          type: 'warning'
        })
        return ''
      }
      if (!this.form.address) {
        this.$message({
          message: this.$t('345b9595.d17095'),
          type: 'warning'
        })
        return ''
      }
    ...
    handleQualificationPicChange: function (file, fileList) {
      ...
      if (file && file.raw) {
        if (file.raw.type != 'image/jpeg' && file.raw.type != 'image/png') {
          this.$message.error(this.$t('345b9595.34e969'))
        }
        if (file.raw.size / 1024 / 1024 > 5) {
          this.$message.error(this.$t('345b9595.50fa12'))
        }
      }
    ...
    pickPics(arr) {
      if (this.picsOldLen + arr.length >= 10) {
        this.$message.error(this.$t('345b9595.4352be'))
        return false
      } else {
        if (arr.length != 0) {
          arr.forEach((data) => {
