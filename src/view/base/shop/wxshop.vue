<template>
  <div>
    <el-tabs v-model="activeName" type="border-card" v-if="$route.path.indexOf('editor') === -1">
      <el-tab-pane label="微信门店管理" name="first">
        ...
        <el-table
          ...
          v-loading="loading"
        >
          <el-table-column prop="storeName" label="门店名称" width="240"> </el-table-column>
          ...
          <el-table-column label="操作" width="170">
            <template slot-scope="scope">
              ...
              <el-button
                ...
                >编辑</el-button
              >
              <el-button size="mini" type="text" v-else :disabled="true">编辑</el-button>
        ...
        <el-dialog title="门店详情" :visible.sync="wxShopsDetailVisible">
          <template>
            <el-row>
              <el-col :span="6"><div class="grid-content">当前状态</div></el-col>
              <el-col :span="12">
            ...
            <el-row v-if="wxShopsDetailData.status == '3'">
              <el-col :span="6"><div class="grid-content">未通过原因</div></el-col>
              <el-col :span="12"
                ><div class="grid-content">{{ wxShopsDetailData.errmsg }}</div></el-col
              >
            </el-row>
            <el-row>
              <el-col :span="6"><div class="grid-content">门店名称</div></el-col>
              <el-col :span="12"
                ><div class="grid-content">{{ wxShopsDetailData.company_name }}</div></el-col
              >
            </el-row>
            <el-row>
              <el-col :span="6"><div class="grid-content">地理位置</div></el-col>
              <el-col :span="12"
                ><div class="grid-content">{{ wxShopsDetailData.address }}</div></el-col
              >
            </el-row>
            <el-row>
              <el-col :span="6"><div class="grid-content">地理位置</div></el-col>
              <el-col :span="12"
                ><div class="grid-content"><img :src="wxShopsDetailData.qqmapimg" /></div
              ></el-col>
            </el-row>
            <el-row>
              <el-col :span="6"><div class="grid-content">联系电话</div></el-col>
              <el-col :span="12"
                ><div class="grid-content">{{ wxShopsDetailData.contract_phone }}</div></el-col
              >
            </el-row>
            <el-row>
              <el-col :span="6"><div class="grid-content">经营资质证件号</div></el-col>
              <el-col :span="12"
                ><div class="grid-content">{{ wxShopsDetailData.credential }}</div></el-col
              >
            </el-row>
            <el-row>
              <el-col :span="6"><div class="grid-content">营业时间</div></el-col>
              <el-col :span="12"
                ><div class="grid-content">{{ wxShopsDetailData.hour }}</div></el-col
              >
            </el-row>
            <el-row>
              <el-col :span="6"><div class="grid-content">门店图片</div></el-col>
              <el-col
                :span="1"
