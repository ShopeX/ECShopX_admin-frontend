    ...
    <div class="column-goods" :style="customStyle">
        ...
        <div class="waterfall-container">
            ...
            <div class="waterfall-column left-column">
                <div v-for="(item, index) in leftColumnItems" :key="item.item_id || item.itemId || `left-${index}`"
            ...
            <div class="waterfall-column right-column">
                <div v-for="(item, index) in rightColumnItems" :key="item.item_id || item.itemId || `right-${index}`"
                    class="column-goods-item">
                    <!-- 商品图片 -->
                    <div class="goods-img-wrapper">
                        <img :src="item.main_img || item.pics?.[0] || ''" class="goods-image" alt="">
