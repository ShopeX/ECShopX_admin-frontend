<template>
    <div class="hotranking-goods" :style="customStyle">
        ...
        <div class="hotranking-goods-list">
            <div v-for="(item, index) in topGoods" :key="`top-${index}`"
...
.hotranking-goods {
    ...
    &-item {
        ...
        &.hotranking-goods-item-1 {
            .top-badge {
                background: #f6efd8;
                border: 1px solid rgba(203, 152, 0, .25);
                color: #cb9800;
            }
        }
        ...
        &.hotranking-goods-item-2 {
            .top-badge {
                background: #e6e9ef;
                border: 1px solid rgba(87, 107, 149, .25);
                color: #576b95;
            }
        }
        ...
        &.hotranking-goods-item-3 {
            .top-badge {
                background: #ffe5d7;
                border: 1px solid rgba(222, 127, 72, .25);
                color: #de7f48;
            }
        }
