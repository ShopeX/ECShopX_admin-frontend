<template>
    <div class="seckill-goods" :style="customStyle">
        ...
        <div class="seckill-header">
            <div class="seckill-header-left">
                <div class="header-title">
                    <img v-if="value.titleType === 'image' && value.titleImage"
                        :src="value.titleImage" class="header-image" alt="">
                    <span v-if="value.titleType === 'text' && value.titleText" class="header-text"
            ...
            <!-- 查看更多 -->
            <div v-if="value.showMoreBtn" class="header-more"
                :style="{ color: value.moreBtnColor }">
        ...
        <div class="seckill-goods-list" ref="goodsListRef">
            <div v-for="(item, index) in goodsList" :key="item.item_id || index" class="seckill-goods-item">
                <!-- 商品图片 -->
...
export default {
    ...
    methods: {
        ...
        getSubsidyAmount(item) {
            ...
            const activityPrice = typeof item.activity_price === 'string' ? parseFloat(item.activity_price) : item.activity_price
