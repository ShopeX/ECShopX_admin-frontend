  ...
  <div class="section section-white">
    <el-form :model="form" label-width="auto" label-position="left" class="demo-ruleForm">
      <template v-if="!isEditor || (isEditor && !form.item_main_cat_id)">
        <el-card shadow="never" header="选择主分类" v-loading="mainCateLoader">
          <el-cascader
      ...
      <template v-if="(!isEditor && selectedMainCategory.length > 0) || isEditor">
              ...
              <el-row :gutter="20">
                <el-col :xs="24" :sm="12" :md="8">
                  <el-form-item label="*商品标题">
                    <el-input v-model="form.item_name" :maxlength="30" placeholder="" :disabled="true"></el-input>
                  </el-form-item>
                </el-col>
                <el-col :xs="24" :sm="12" :md="8">
                  <el-form-item label="副标题">
                    <el-input v-model="form.brief" :maxlength="30" placeholder="" :disabled="true"></el-input>
                  </el-form-item>
                </el-col>
                <el-col :xs="24" :sm="12" :md="8">
                  <el-form-item label="计量单位">
                    <el-input v-model="form.item_unit" :maxlength="60" placeholder="" :disabled="true"></el-input>
                  </el-form-item>
                </el-col>
                <el-col :xs="24" :sm="12" :md="8">
                  <el-form-item label="排序编号">
                    <el-input v-model="form.sort" placeholder="" :disabled="true"></el-input>
                  </el-form-item>
                </el-col>
                <el-col :xs="24" :sm="12" :md="8">
        ...
        <el-card shadow="never" v-loading="loader">
          ...
          <el-radio-group v-model="form.special_type">
            <el-radio label="normal" :disabled="true">普通商品</el-radio>
            <el-radio label="drug" :disabled="true">处方药</el-radio>
          </el-radio-group>
        </el-card>
        <el-card shadow="never" v-loading="loader">
          <div slot="header" class="clearfix">
              ...
              <el-row :gutter="20">
                <el-col :xs="24" :sm="12" :md="8" :lg="6" v-for="(item, index) in params" :key="index">
                  <el-form-item :label="item.label">
                    <el-select v-if="item.children.length > 0" v-model="form.item_params[index].attribute_value_id" placeholder="请选择">
                      <el-option
                        :disabled="true"
                    ...
                    <el-input v-else v-model="form.item_params[index].attribute_value_name" :maxlength="60" placeholder="" :disabled="true"></el-input>
                  </el-form-item>
                </el-col>
              </el-row>
            </div>
            ...
            <el-row :gutter="20">
              ...
              <el-col :xs="24" :sm="12" :md="8">
                <el-form-item label="条形码">
                  <el-input type="number" required min="0" v-model="form.barcode" placeholder=""></el-input>
                </el-form-item>
              </el-col>
            </el-row>
          </template>
        ...
        <el-card header="图文详情" shadow="never" v-loading="loader">
          ...
          <template v-if="mode === 'richText'">
            <vue-html5-editor :content="form.intro" :height="360"></vue-html5-editor>
          </template>
          <template v-else>
        ...
        <div class="section-footer with-border content-center">
          ...
          <el-button v-if="form.audit_status == 'processing'" type="primary" size="small" icon="el-icon-edit" @click="dialogVisible=true">审核商品</el-button>
        </div>
      </template>
    </el-form>
    <el-dialog title="审核商品" :visible.sync="dialogVisible" width="30%">
      <el-form :model="authForm" label-width="80px">
        ...
        <el-form-item v-if="authForm.audit_status == 'rejected'" label="拒绝原因">
          <el-input type="textarea" v-model="authForm.audit_reason"></el-input>
        </el-form-item>
        <el-form-item>
...
<script>
  ...
  import { getItemsDetail, createItems, updateItems, getCategory, getGoodsAttr, getCategoryInfo, auditItems } from '@/api/goods'
