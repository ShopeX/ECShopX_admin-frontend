  ...
  <div class="distributor-form">
    <el-card v-if="is_normal" class="el-card--normal" header="店铺类型">
      <el-form ref="form" label-width="120px" :model="form" :rules="rules">
        ...
        <el-form-item v-if="form.distribution_type === 1" label="所属商户" prop="merchant_id">
          <el-select
    ...
    <ImageForm ref="imageFormRef" :external-form="form" />
    ...
    <DadaForm
      ...
      @onChangeData="handleChangeData"
    />
    <IntroduceForm ref="introduceFormRef" :external-form="form" />
