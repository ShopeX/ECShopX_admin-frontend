  ...
  <div>
    ...
    <el-card>
      ...
      >
        ...
        <el-table-column v-if="$store.getters.login_type != 'distributor'" width="340" label="操作">
          <template slot-scope="scope">
            <el-button type="text">
              <router-link
                :to="{
            ...
            <el-button type="text" v-if="scope.row.category_level < 3" @click="append(scope.row)"
              >新增子类</el-button
            >
