...
<template>
  <div>
    ...
    >
      ...
      <el-table-column width="150" prop="name" :label="$t('920c3d68.621f21')" />
      <el-table-column width="200" :label="$t('920c3d68.087003')">
        <template slot-scope="scope">
          {{ scope.row.area | formatCityData(district) }}
        </template>
      </el-table-column>
      <el-table-column prop="up" :label="$t('e224c0e0.2548e6')" />
      <el-table-column prop="down" :label="$t('e224c0e0.ab2259')" />
      <el-table-column prop="basefee" :label="$t('e224c0e0.9a935b')" />
