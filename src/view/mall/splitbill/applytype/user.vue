<template>
  <div>
    <el-alert
      ...
      :closable="false"
    ></el-alert>
    <el-divider v-if="form_user.status == 4"></el-divider>
    <div class="formClass">
      <el-form ref="form_user" :model="form_user" label-width="150px" :rules="solo_rules">
        ...
        <el-form-item label="用户姓名" prop="user_name">
          <el-input v-model="form_user.user_name" :disabled="disabled"></el-input>
        </el-form-item>
        <el-form-item label="手机号" prop="user_mobile">
          <el-input v-model="form_user.user_mobile" :disabled="disabled"></el-input>
        </el-form-item>
        ...
        <el-form-item label="身份证号码" prop="id_card">
          <el-input v-model="form_user.id_card" :disabled="disabled"></el-input>
        </el-form-item>
        <el-form-item label="结算银行卡号" prop="bank_acct_num">
          <el-input v-model="form_user.bank_acct_num" :disabled="disabled"></el-input>
        </el-form-item>
        <el-form-item>
          <el-button type="primary" @click="onUserSubmit" v-if="!disabled">保存</el-button>
        </el-form-item>
      </el-form>
    </div>
  </div>
  ...
  data() {
    ...
    return {
      ...
      solo_rules: {
        ...
        bank_acct_num:[
          { required: true, message: '请填写结算银行卡号', trigger: 'blur' },
        ]
      }
    }
  },
