...
<template>
  <div>
    ...
    >
      ...
      <el-table-column prop="name" width="150" :label="$t('647ce252.621f21')" />
      <el-table-column width="200" :label="$t('647ce252.087003')">
        <template slot-scope="scope">
          {{ scope.row.area | formatCityData(district) }}
        </template>
      </el-table-column>
      <el-table-column prop="start_standard" :label="$t('654382a0.cb7d60')" />
      <el-table-column prop="start_fee" :label="$t('647ce252.23e30a')" />
      <el-table-column prop="add_standard" :label="$t('654382a0.a472ba')" />
      ...
      <el-table-column :label="$t('647ce252.2b6bc0')" width="100">
        <template slot-scope="scope">
