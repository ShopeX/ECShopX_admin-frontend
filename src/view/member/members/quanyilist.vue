...
<template>
  <div class="section-white">
    ...
    <el-table :data="rightsList" v-loading="loading" border>
      ...
      <el-table-column prop="operator_desc" label="代客下单操作员"></el-table-column>
      ...
      <el-table-column label="状态">
        <template slot-scope="scope">
          ...
          <el-tag type="success" v-else-if="scope.row.is_valid == '1'" size="mini">有效</el-tag>
