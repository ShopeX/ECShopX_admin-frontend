<template>
  <div>
    <el-row :gutter="10">
      <el-col :md="8" :lg="6">
        <el-input placeholder="订单号" v-model="params.order_id">
          <el-button slot="append" icon="el-icon-search" @click="getLuckyDrawTeamList"></el-button>
        </el-input>
      </el-col>
      <el-col :md="8" :lg="6">
    ...
    <el-table :data="luckyDrawTeamList" style="width: 110%" border height="580" v-loading="loading">
      <el-table-column prop="luckydraw_trade_id" label="订单号" width="180"></el-table-column>
      <el-table-column prop="lucky_code" label="抽奖号码" width="120"></el-table-column>
      <el-table-column prop="member_info.backend_mobile" label="手机号" width="120">
        <template slot-scope="scope">
          <router-link
            ...
            >{{ scope.row.member_info.backend_mobile }}</router-link
          >
        </template>
      </el-table-column>
      <el-table-column prop="member_info.username" label="姓名" width="100"></el-table-column>
      ...
      <el-table-column label="支付状态" width="100">
        <template slot-scope="scope">
          ...
          <el-tag v-else-if="scope.row.payment_status == 'refunded'" type="warning">已退款</el-tag>
      ...
      <template>
        ...
        <el-form ref="deliveryForm" :model="deliveryForm" class="demo-ruleForm" label-width="100px">
          <el-form-item label="抽奖订单号">
            <el-col :span="20">{{ deliveryData.luckydraw_trade_id }}</el-col>
          </el-form-item>
          <el-form-item label="商品名称">
            <el-col :span="20">{{ deliveryData.item_name }}</el-col>
          </el-form-item>
          <el-form-item label="积分">
            <el-col :span="20">{{ deliveryData.luckydraw_point }}</el-col>
          </el-form-item>
          <el-form-item label="收货地址" v-if="deliveryData.address_id">
            <el-col :span="20">
          ...
          <el-form-item label="收货人" v-if="deliveryData.address_id">
            <el-col :span="20">{{ deliveryData.address.username }}</el-col>
          </el-form-item>
          <el-form-item label="手机号" v-if="deliveryData.address_id">
            <el-col :span="20">{{ deliveryData.address.telephone }}</el-col>
          </el-form-item>
