    ...
    <div v-if="$route.path.indexOf('editor') === -1">
      ...
      <el-tabs type="border-card" v-model="activeName" @tab-click="handleClick">
        ...
        >
          ...
          <el-table-column prop="marketing_name" min-width="150" label="促销名称"></el-table-column>
          <el-table-column label="规则" min-width="150">
              <template slot-scope="scope">
                  <div v-for="(item,index) in scope.row.condition_value" :key="index">
                    ...
                    消费满{{item.full}}件,加价购(<el-button type="text" @click="viewGiftItemList(scope.row)">加购商品</el-button>)
                    </span>
                    <span v-if="scope.row.condition_type == 'totalfee'">
                    消费满{{item.full}}元,加价购(<el-button type="text" @click="viewGiftItemList(scope.row)">加购商品</el-button>)
                    </span>
                  </div>
              </template>
          </el-table-column>
      ...
      >
        <template>
          <el-table :data="activityItemListsData" v-loading="ItemLoading">
      ...
      >
        <template>
          <el-table :data="purchaseRules" v-loading="ItemLoading">
