  ...
  <div>
    <div v-if="$route.path.indexOf('detail') === -1 && $route.path.indexOf('editor') === -1">
      <el-row class="content-bottom-padded" :gutter="20">
        <el-col :span="4">
          <el-button type="primary" icon="plus" @click="addElement">表单元素添加</el-button>
        </el-col>
        <el-col :span="6">
          <el-select
            placeholder="请选择表单元素"
        ...
        <el-col :span="6">
          <el-input placeholder="标题" v-model="params.field_title" style="width: 100%"
      ...
      <el-tabs v-model="activeName" type="border-card" @tab-click="handleClick">
        ...
        >
          <el-table :data="ItemsList" :height="wheight - 280" v-loading="loading">
            ...
            <el-table-column prop="field_title" label="标题" width="250"></el-table-column>
            <el-table-column
              prop="field_name"
              label="唯一标示(纯字母)"
              width="200"
            ></el-table-column>
            <el-table-column prop="form_element" label="元素类型" width="100"></el-table-column>
