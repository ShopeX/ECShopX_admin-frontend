  ...
  <div>
    <div class="log-header">
      <div class="log-container">
        ...
        <div class="log-welcome">{{ $t('53bb49eb.04b015') }}</div>
      </div>
    </div>
    <div
      class="log-body"
    ...
    >
      <div class="log-container">
        <el-tabs type="border-card" value="admin" style="width: 400px" class="login-type-tab">
          <el-tab-pane name="admin" :label="$t('53bb49eb.89f98a')">
            <div class="log-img" />
            <el-form
              ref="ruleForm1"
              :model="ruleForm1"
...
export default {
  data() {
    const validateEmail = (rule, value, callback) => {
      if (!isMobile(value)) {
        callback(new Error(this.$t('53bb49eb.e56e22')))
      } else {
        callback()
      }
    }
    const validatePass = (rule, value, callback) => {
      if (value.length < 6) {
        callback(new Error(this.$t('53bb49eb.395316')))
      } else {
        callback()
      }
    }
