<template>
  <div>
    <el-row :gutter="20">
      ...
      <el-col :span="6">
        <el-input placeholder="推广员" v-model="params.promoter_mobile"></el-input>
      </el-col>
      <el-col :span="10">
        <el-date-picker
          v-model="search_time"
    ...
    <el-row :gutter="20">
      <el-col :span="6">
        <el-input placeholder="商品" v-model="params.item_name"></el-input>
      </el-col>
      <el-col :span="4">
    ...
    <el-tabs v-model="params.status" type="border-card" @tab-click="handleClick">
      <el-tab-pane name="wait" label="待统计"></el-tab-pane>
      <el-tab-pane name="finish" label="已统计"></el-tab-pane>
      <el-tab-pane name="close" label="关闭"></el-tab-pane>
      <el-table
        :data="list"
        style="width: 100%"
        :height="wheight - 170"
      ...
      >
        ...
        <el-table-column prop="promoter_mobile" label="推广员"></el-table-column>
        <el-table-column prop="buy_mobile" label="购买用户"></el-table-column>
        ...
        <el-table-column prop="plan_date" min-width="80" label="账期"></el-table-column>
        <el-table-column label="状态" min-width="60">
          <template slot-scope="scope">
            <el-tag type="success" v-if="scope.row.status == 'finish'">已完成</el-tag>
            <el-tag type="info" v-if="scope.row.status == 'close'">关闭</el-tag>
            <el-tag type="warning" v-if="scope.row.status == 'wait'">待统计</el-tag>
          </template>
        </el-table-column>
      </el-table>
