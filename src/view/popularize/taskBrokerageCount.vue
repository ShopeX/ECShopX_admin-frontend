<template>
  <div>
    ...
    >
      ...
      <el-table-column prop="finish_num" label="已完成数量" min-width="80"></el-table-column>
      <el-table-column prop="wait_num" label="待完成数量" min-width="80"></el-table-column>
      <el-table-column prop="close_num" label="退回数量" min-width="80"></el-table-column>
      ...
      <el-table-column label="状态" min-width="60">
        <template slot-scope="scope">
          <el-tag type="success" v-if="scope.row.status">已达标</el-tag>
