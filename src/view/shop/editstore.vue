  ...
  <section class="section section-white content-padded" onload="init()">
    <el-form ref="form" :model="form" label-width="110px">
      ...
      <el-form-item label="门店名称">
        <div>
          <el-col :span="8"
            ><el-input v-model="form.shopname" placeholder="请先完成上方地理位置的选择"></el-input
          ></el-col>
        </div>
      </el-form-item>
      ...
      <el-form-item label="经营资质主体" v-show="add_flag === 1" v-if="form.is_domestic == '1'">
        <el-radio-group v-model="form.add_type">
          <div style="margin-bottom: 10px;">
            <el-radio :label="1"
              >公众账号主体&nbsp;<span class="frm-tips">({{ principal_name }})</span></el-radio
            >
          </div>
          <div>
            <el-radio :label="2"
    ...
    <div id="qqmap_infowin" v-show="qqmap_infowin_flag">
      <el-col
        ><el-button type="primary" @click="imp_poi(poi_info)">导入该门店信息</el-button></el-col
      >
