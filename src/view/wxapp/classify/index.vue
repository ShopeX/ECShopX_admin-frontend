    ...
    <div>
        <div v-if="$route.path.indexOf('detail') === -1">
                ...
                <el-table-column label="操作" min-width="100">
                    <template slot-scope="scope">
                        ...
                        <el-popover v-if="appID" placement="top" width="200" trigger="click">
                            ...
                            <el-button slot="reference" style="width: 45px" type="text"
            ...
            <div class="content-padded content-center">
                <el-pagination background layout="prev, pager, next" :current-page.sync="params.page"
                    :total="total_count" :page-size="params.pageSize" @current-change="handleCurrentChange" />
            </div>
            <el-dialog :title="dialogTitle" :visible.sync="page_dialog" :close-on-click-modal="false"
                ...
                <el-form v-model="pageForm" label-width="200px">
                    ...
                    <el-form-item label="页面描述">
                        <el-input v-model="pageForm.page_description" placeholder="页面描述" style="width: 55%" />
                    </el-form-item>
                    <el-form-item label="分享标题">
                        <el-input v-model="pageForm.page_share_title" placeholder="分享标题" style="width: 55%" />
                    </el-form-item>
                    <el-form-item label="关联分类">
                        <el-select v-model="value" placeholder="请选择关联分类">
                    ...
                    <el-form-item label="分享图片">
                        <div class="upload-box" @click="handleImgChange()">
                            <img v-if="pageForm.page_share_imageUrl" :src="wximageurl + pageForm.page_share_imageUrl"
                                class="avatar">
            ...
            <el-dialog :visible.sync="template_dialog" destroy-on-close title="编辑页面" fullscreen lock-scroll>
                <shopDecoration :id="pageForm.id" usage="page" pagetype="cuspage" :rel-store="store"
                    :template_name="template_name" @saved="closeDialog" />
            </el-dialog>
        </div>
        <router-view />
    </div>
