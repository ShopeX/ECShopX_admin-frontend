      ...
      >
        <el-form v-model="pageForm" label-width="200px">
          ...
          <el-form-item label="页面类型">
            <el-select v-model="pageForm.page_type" placeholder="页面类型">
              <el-option label="自定义" value="normal" />
              <el-option label="个人中心" value="my" />
            </el-select>
          </el-form-item>
          ...
          <el-form-item label="区域">
            <el-select v-model="pageForm.regionauth_id" placeholder="区域">
              <el-option v-for="item in areas" :key="item.id" :label="item.label" :value="item.value" />
            </el-select>
          </el-form-item>
  ...
  methods: {
    ...
    savePage() {
      ...
      if (this.dialogTitle == '编辑页面') {
        editCustomPage(this.pageForm.id, params).then((res) => {
