  ...
  <div>
    <section class="section section-white app_detail_overview">
      <div class="section-header">
        <div class="section-title">{{ $t('4c38fab6.0225d7') }}</div>
      </div>
        ...
        <div v-loading="surveyLoading" class="data_overview_list_wrp">
          <div class="data_overview_list js_YO_dataBox">
            <div class="data_overview_item">
              <p class="data_overview_title">{{ $t('4c38fab6.744b98') }}</p>
            ...
            <div class="data_overview_item">
              <p class="data_overview_title">{{ $t('4c38fab6.0d8ac2') }}</p>
              <p class="data_overview_desc">
            ...
            <div class="data_overview_item">
              <p class="data_overview_title">{{ $t('4c38fab6.e23fa3') }}</p>
              <p class="data_overview_desc">
            ...
            <div class="data_overview_item">
              <p class="data_overview_title">{{ $t('4c38fab6.9c9ca3') }}</p>
              <p class="data_overview_desc">
    ...
    <section class="section section-white">
      ...
      <div class="section-header">
        <el-select v-model="chart.date" :placeholder="$t('4c38fab6.708c9d')" @change="chartHandle">
          <el-option
            v-for="item in date"
            :key="item.value"
            :label="$t(item.label)"
    ...
    <section class="section section-white">
      ...
      <div class="section-body">
        <el-table v-loading="visitPage.visitLoading" :data="visitPage.list">
          <el-table-column prop="page_path" :label="$t('4c38fab6.e3a8a6')" />
          <el-table-column prop="pv_num" :label="$t('4c38fab6.f0be64')" width="180" />
          <el-table-column prop="percent" :label="$t('4c38fab6.c909e6')" width="180" />
        </el-table>
      </div>
    </section>
  </div>
...
export default {
  ...
  data() {
    return {
      ...
      date: [
        {
          label: '4c38fab6.2f8d6f',
          value: 'yesterday'
        },
        {
          label: '4c38fab6.73bef6',
          value: 'weekly'
        },
        {
          label: '4c38fab6.63f66f',
          value: 'monthly'
        }
      ],
      pickerOptions: null,
      ...
      chart: {
        tabCon: [
          {
            label: '4c38fab6.665c66',
            value: 'visit_total'
          },
          {
            label: '4c38fab6.744b98',
            value: 'session_cnt'
          },
          {
            label: '4c38fab6.f0be64',
            value: 'visit_pv'
          },
          {
            label: '4c38fab6.c3c959',
            value: 'visit_uv'
          },
          {
            label: '4c38fab6.e23fa3',
            value: 'visit_uv_new'
          },
          {
            label: '4c38fab6.76dc08',
            value: 'share_pv'
          },
          {
            label: '4c38fab6.4058cc',
            value: 'share_uv'
          },
          {
            label: '4c38fab6.46a146',
            value: 'stay_time_uv'
          },
          {
            label: '4c38fab6.dc6331',
            value: 'stay_time_session'
          }
        ],
        currentTabName: '4c38fab6.665c66',
      ...
      visitPage: {
        tabCon: [
          {
            label: '4c38fab6.e9dd7b',
            value: 'entrypage_pv'
          },
          {
            label: '4c38fab6.515127',
            value: 'page_visit_pv'
          }
        ],
        currentTabName: '4c38fab6.515127',
  ...
  computed: {
    pickerOptions() {
      return {
        shortcuts: [
          {
            text: this.$t('4c38fab6.800dfd'),
            onClick(picker) {
              picker.$emit('pick', new Date())
            }
          },
          {
            text: this.$t('4c38fab6.2f8d6f'),
            onClick(picker) {
              const date = new Date()
