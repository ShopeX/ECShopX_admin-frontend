    ...
    <div v-if="visible" class="tpl-panel" v-loading="loading">
      ...
      <div v-else class="tpl-grid">
        ...
        >
          ...
          >
            <i
              v-if="!coverOf(t) && !previewVideoOf(t)"
              class="el-icon-picture-outline cover-fallback"
            ></i>
...
export default {
  ...
  methods: {
    ...
    previewVideoOf(t) {
      ...
      const raw =
        ...
        (() => {
          ...
          return (
            outputs.find(
              (u) => typeof u === 'string' && /\.(mp4|mov|m4v|webm|mkv|avi)(\?|$)/i.test(u)
            ) || ''
          )
        })()
      if (!raw) return ''
    ...
    coverOf(t) {
      if (!t) return ''
      const isVideoUrl = (u) =>
        typeof u === 'string' && /\.(mp4|mov|m4v|webm|mkv|avi)(\?|$)/i.test(u)
...
.tpl-type-badge.is-video {
  background: rgba(64, 158, 255, 0.85);
}
.tpl-type-badge.is-audio {
