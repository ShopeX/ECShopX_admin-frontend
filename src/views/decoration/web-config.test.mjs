...
test('web config page contains mall logo, login page, and SEO settings', () => {
  ...
  assert.match(source, /42c71eaf\.1d2582/)
  assert.match(source, /component:\s*'Divider'/)
  assert.match(source, /42c71eaf\.73a7f4/)
  assert.match(source, /42c71eaf\.7de289/)
  assert.match(source, /42c71eaf\.1efa53/)
...
test('web config API and routes are wired to the new page', () => {
  ...
  assert.match(moduleRoute, /42c71eaf\.1d2582/)
